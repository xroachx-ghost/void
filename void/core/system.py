...
class SystemTweaker:
    ...
    def force_usb_debugging(device_id: str, method: str = 'all') -> dict:
        ...
        if method in ['all', 'standard', 'properties']:
            run_step("restart_adbd_stop", ['adb', '-s', device_id, 'shell', 'stop', 'adbd'], 'daemon')
            run_step("restart_adbd_start", ['adb', '-s', device_id, 'shell', 'start', 'adbd'], 'daemon')
        ...
        if method in ['all', 'properties']:
            ...
            run_step(
                ...
                ['adb', '-s', device_id, 'shell', 'setprop', 'persist.sys.usb.config', 'mass_storage,adb'],
                'alternative'
            )
            run_step(
        ...
        return {
            "methods": [
                ...
                },
                {
                    ...
                    "requirements": ["Root access", "System remount capability", "Bootloader unlocked (usually)"],
                ...
                },
                {
                    ...
                    "requirements": ["Custom recovery (TWRP)", "Bootloader unlocked", "ADB in recovery"],
                    "risk_level": "Medium-High",
                ...
                },
                {
                    ...
                    "requirements": ["OTG adapter", "USB mouse or keyboard", "Broken screen but display works", "Device unlocked"],
                    "risk_level": "None",
                ...
                },
                {
                    ...
                    "requirements": ["Fastboot mode access", "Bootloader unlocked", "OEM specific support"],
                    "risk_level": "Low-Medium",
                ...
                },
                {
                    ...
                    "requirements": ["Magisk installed", "Root access", "Custom recovery or Magisk app"],
                    "risk_level": "Medium",
