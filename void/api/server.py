...
def create_app() -> FastAPI:
    ...
    async def create_backup(
        device_id: str, request: BackupRequest, user: dict = Depends(get_current_user)
    ):
    ...
    async def enable_usb_debugging(
        device_id: str, request: USBDebugRequest, user: dict = Depends(get_current_user)
    ):
    ...
    async def reboot_device(
        device_id: str, mode: str = "system", user: dict = Depends(get_current_user)
    ):
        """Reboot device"""
